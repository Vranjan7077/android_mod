...
import com.bloombrain.Activity.PlanActivity;
...
public class Profile extends Fragment  {
    ...
    public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle) {
        View view = paramLayoutInflater.inflate(R.layout.fragment_profile, paramViewGroup, false);

        btnViewPlans = (Button)view.findViewById(R.id.btn_view);
